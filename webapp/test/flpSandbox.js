		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comlhccustodioprojetossapbasnw-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlhccustodioprojetossapbasnw-display": {
								"semanticObject": "comlhccustodioprojetossapbasnw",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lhccustodio.projetos.sapbas.odata.nw",
									"url": sap.ui.require.toUrl("com/lhccustodio/projetos/sapbas/nw")
								}
							}
						}
					}
